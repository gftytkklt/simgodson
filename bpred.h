...
struct bpred_update_t {
  ...
  char st;              /* remember the value read */
...
#define BTB_TAG_BITS    6
#define BTB_TAG_MASK    ((1<<6) - 1)
#define BTB_TARGET_BITS 24 
#define BTB_TARGET_MASK ((1<<BTB_TARGET_BITS) - 1)

extern void decode_update_ghr(struct bpred_t *pred,/*tick_t now,*/int predict);
...
extern int pred_21264_nelt;

extern int pred_21264_config[];
...
extern int gindex;
extern int cindex;
extern int specgindex;
extern int speccindex;
extern int bpred_spec_update;
